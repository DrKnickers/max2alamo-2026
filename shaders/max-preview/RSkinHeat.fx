// max2alamo-2026 :: shaders/max-preview/RSkinHeat.fx
//
// Effects11 STUB shader for 3ds Max 2026 authoring preview.
// Mirrors the parameter surface of Petroglyph's stock RSkinHeat.fx for Max-side UI.
...
float4 std_PS(VsOut IN) : SV_Target {
    float4 base = DistortionTexture.Sample(DistortionTextureSampler, IN.UV);
