// max2alamo-2026 :: shaders/max-preview/MeshShield.fx
//
// Effects11 STUB shader for 3ds Max 2026 authoring preview.
// Mirrors the parameter surface of Petroglyph's stock MeshShield.fx for Max-side UI.
...
float DistortUVScale <
    string UIName = "DistortUVScale";
> = 1.0;

float BaseUVScrollRate <
    string UIName = "BaseUVScrollRate";
> = 1.0;

float WaveUVScrollRate <
    string UIName = "WaveUVScrollRate";
> = 1.0;

float DistortUVScrollRate <
    string UIName = "DistortUVScrollRate";
> = 1.0;
...
Texture2D <float4> WaveTexture <
    string UIName = "WaveTexture";
    string UIType = "bitmap";
    string ResourceType = "2D";
>;
SamplerState WaveTextureSampler {
    MinFilter = Linear; MagFilter = Linear; MipFilter = Linear;
    AddressU = Wrap; AddressV = Wrap;
};
