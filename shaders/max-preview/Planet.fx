// max2alamo-2026 :: shaders/max-preview/Planet.fx
//
// Effects11 STUB shader for 3ds Max 2026 authoring preview.
// Mirrors the parameter surface of Petroglyph's stock Planet.fx for Max-side UI.
...
float4 Atmosphere <
    string UIName = "Atmosphere";
    string UIType = "ColorSwatch";
    string UIWidget = "Color";
> = { 0.0, 0.0, 0.0, 1.0 };

float3 CityColor <
    string UIName = "CityColor";
    string UIType = "ColorSwatch";
    string UIWidget = "Color";
> = { 1.0, 1.0, 1.0 };

float AtmospherePower <
    string UIName = "AtmospherePower";
> = 4.5;
...
Texture2D <float4> CloudNormalTexture <
