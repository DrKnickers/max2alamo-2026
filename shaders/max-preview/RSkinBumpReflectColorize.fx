// max2alamo-2026 :: shaders/max-preview/RSkinBumpReflectColorize.fx
//
// Effects11 STUB shader for 3ds Max 2026 authoring preview.
// Mirrors the parameter surface of Petroglyph's stock RSkinBumpReflectColorize.fx for Max-side UI.
