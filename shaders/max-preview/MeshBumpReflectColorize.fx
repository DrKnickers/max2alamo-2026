// max2alamo-2026 :: shaders/max-preview/MeshBumpReflectColorize.fx
//
// Effects11 STUB shader for 3ds Max 2026 authoring preview.
// Mirrors the parameter surface of Petroglyph's stock MeshBumpReflectColorize.fx for Max-side UI.
